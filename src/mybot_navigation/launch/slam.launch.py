"""RTAB-Map RGB-D VSLAM.
    ...
    ros2 launch mybot_navigation slam.launch.py                # 지도 작성
    ros2 launch mybot_navigation slam.launch.py localization:=true  # 기존 지도로 위치추정
...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument(
            'database_path', default_value='~/.ros/mybot_rtabmap.db',
