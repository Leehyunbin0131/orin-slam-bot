...
def generate_launch_description():
    desc_share = FindPackageShare('mybot_description')
    bringup_share = FindPackageShare('mybot_bringup')

    xacro_file = PathJoinSubstitution([desc_share, 'urdf', 'mybot.urdf.xacro'])
